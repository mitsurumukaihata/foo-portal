...
const FOO_STOCK_DB_MAP = {
  'LTL TB　ノーマル': {
    ...
    patterns:['M646','M676','M125','M317','M323','M319','M320','M619','M626','M888','M899','M801','M746','R225','R241','G539','SP680','SP122','XJE4','M149','M166','M620','M628','M638','M666','M667','M810','M748','R221II','R02','SP068','SP688','SP688ACE','Allroads D','FR01','FR01S','TR01','TR01T','R02PFD','ADR26','SP011'],
  },
  'LTL TB　スタッドレス': {
    key: 'ltl_studless',
    ...
    icon:    '❄️',
    sizes:   ['225/80R17.5','225/90R17.5','215/70R17.5 123/121','235/70R17.5','245/80R17.5','245/70R19.5','265/70R19.5','9R19.5','275/70R22.5','275/80R22.5','295/70R22.5','295/80R22.5','255/70R22.5','315/80R22.5','385/65R22.5','11R22.5','10R22.5'],
    patterns:['M929','M919','M966','M920','M939','W910','W900S','W911','W970','W999','SP001','SP081','SP088','XDW','M917','M923','W900','W01PRO'],
  },
  'LTS　ノーマル': {
    key: 'lts_normal',
    ...
    patterns:['M634','M135','M134e','M131','M319','M804','R207','SPLT50','SPLT21','SPLT22','M133','M139','M136','M636'],
  },
  'LTS　スタッドレス': {
    key: 'lts_studless',
  ...
  'RT 再生': {
    ...
    patterns:['RTM919','RTM810','RTM804','RTM807','RTM81C-170','RTM890','RTW910','RTW911','RTW970','RTG610','更生タイヤ','RT919','RT810','RT804'],
  },
  'T/T チューブタイプ': {
    key: 'tt',
    ...
    patterns:['M614','M626','M125','M131','M134','M319','M501','M504','M519','M919','M935','M890','R225','SP185'],
  },
  'バン': {
    key: 'van',
    ...
    patterns:['V03e','V02e','V02','M935','K370','K370Z','R710','V600','W300','W989','LV01','VL10A','VAN01','SV01','C1S','C1SA','LuII','SU','T1R'],
  },
  'リフト': {
    key: 'lift',
...
/**
 * サイズコード正規化（全角→半角、スペース統一）
 */
function fooNormalizeSize(s) {
  if (!s) return '';
  return s
    .replace(/[０-９]/g, c => String.fromCharCode(c.charCodeAt(0) - 0xFEE0))
    .replace(/[Ａ-Ｚａ-ｚ]/g, c => String.fromCharCode(c.charCodeAt(0) - 0xFEE0))
    .replace(/Ｐ/g, 'P').replace(/Ｒ/g, 'R')
